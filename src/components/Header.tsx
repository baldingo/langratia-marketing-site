        ...
        <div className="hidden lg:flex lg:items-center lg:gap-1.5">
          ...
          <Link
            ...
            className={`text-xs font-bold px-3.5 py-2 rounded-full transition-all duration-200 ${
              pathname === "/" ? "bg-[#6855F0] text-white shadow-sm" : "text-[#1E1548]/80 hover:text-[#6855F0] hover:bg-[#6855F0]/10"
            }`}
          >
            Home
          </Link>
          ...
          <Link
            href="/about"
            className={`text-xs font-bold px-3.5 py-2 rounded-full transition-all duration-200 ${
              pathname === "/about" ? "bg-[#6855F0] text-white shadow-sm" : "text-[#1E1548]/80 hover:text-[#6855F0] hover:bg-[#6855F0]/10"
            }`}
          >
            About
          </Link>
